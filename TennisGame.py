class TennisGame(object):
    ...
    def __init__(self, first_player_name, second_player_name):
        ...
        self.score_look_up = {0: 'love',1:'fifteen',2:'thirty',3:'forty'}
    ...
    def same_score(self):
        return self.score_look_up[self.first_player_score_times] + ' all'

    def is_deuce(self):
        return self.first_player_score_times >= 3

    def normal_score(self):
        return self.score_look_up[self.first_player_score_times] + " " + self.score_look_up[
